...
public class RtpStreamReceiver extends Thread {
	...
	public static synchronized void ringback(boolean ringback) {
		if (ringback && ringbackPlayer == null) {
			...
			ringbackPlayer = new ToneGenerator(stream(),(int)(ToneGenerator.MAX_VOLUME*2*com.sipgate.sipua.ui.Settings.getEarGain()));
	...
	void restoreVolume() {
		...
		case AudioManager.MODE_IN_CALL:
				setStreamVolume(AudioManager.STREAM_RING,(int)(
						...
						com.sipgate.sipua.ui.Settings.getEarGain()), 0);
				track.setStereoVolume(AudioTrack.getMaxVolume()*
						com.sipgate.sipua.ui.Settings.getEarGain()
	...
	void saveSettings() {
		if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_OLDVALID, com.sipgate.sipua.ui.Settings.DEFAULT_OLDVALID)) {
			...
			if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).contains(com.sipgate.sipua.ui.Settings.PREF_OLDVIBRATE2))
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putInt(com.sipgate.sipua.ui.Settings.PREF_OLDVIBRATE, oldvibrate);
			edit.putInt(com.sipgate.sipua.ui.Settings.PREF_OLDVIBRATE2, oldvibrate2);
			edit.putInt(com.sipgate.sipua.ui.Settings.PREF_OLDPOLICY, oldpolicy);
			edit.putInt(com.sipgate.sipua.ui.Settings.PREF_OLDRING, am.getStreamVolume(AudioManager.STREAM_RING));
			edit.putBoolean(com.sipgate.sipua.ui.Settings.PREF_OLDVALID, true);
			edit.commit();
		}
	}
	...
	public static void setMode(int mode) {
		Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
		edit.putBoolean(com.sipgate.sipua.ui.Settings.PREF_SETMODE, true);
		edit.commit();
		AudioManager am = (AudioManager) Receiver.mContext.getSystemService(Context.AUDIO_SERVICE);
		if (Integer.parseInt(Build.VERSION.SDK) >= 5)
	...
	public static void restoreMode() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_SETMODE, com.sipgate.sipua.ui.Settings.DEFAULT_SETMODE)) {
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(com.sipgate.sipua.ui.Settings.PREF_SETMODE, false);
			edit.commit();
	...
	public static void restoreSettings() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_OLDVALID, com.sipgate.sipua.ui.Settings.DEFAULT_OLDVALID)) {
			...
			int oldvibrate = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(com.sipgate.sipua.ui.Settings.PREF_OLDVIBRATE, com.sipgate.sipua.ui.Settings.DEFAULT_OLDVIBRATE);
			int oldvibrate2 = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(com.sipgate.sipua.ui.Settings.PREF_OLDVIBRATE2, com.sipgate.sipua.ui.Settings.DEFAULT_OLDVIBRATE2);
			int oldpolicy = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(com.sipgate.sipua.ui.Settings.PREF_OLDPOLICY, com.sipgate.sipua.ui.Settings.DEFAULT_OLDPOLICY);
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(com.sipgate.sipua.ui.Settings.PREF_OLDVALID, false);
			edit.commit();
	...
	public void run() {
		boolean nodata = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_NODATA, com.sipgate.sipua.ui.Settings.DEFAULT_NODATA);
		...
		ToneGenerator tg = new ToneGenerator(AudioManager.STREAM_VOICE_CALL,(int)(ToneGenerator.MAX_VOLUME*2*com.sipgate.sipua.ui.Settings.getEarGain()));
		track.play();
		System.gc();
		while (running) {
			Receiver.lock(true);
