...
public class Sipdroid extends Activity {
	...
	public static final int SIPGATE_SETUP_MENU_ITEM = FIRST_MENU_ID + 5;
...
//		m.setIcon(android.R.drawable.ic_menu_call);
		m = menu.add(0, SIPGATE_SETUP_MENU_ITEM, 0, R.string.menu_sipgate_setup);
		m.setIcon(R.drawable.android_menu_icon_48);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case CONFIGURE_MENU_ITEM: {
			try {
				intent = new Intent(this, com.sipgate.sipua.ui.Settings.class);
				startActivity(intent);
			} catch (ActivityNotFoundException e) {
			}
		}
