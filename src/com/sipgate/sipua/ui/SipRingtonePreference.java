...
{   
    ...
    protected void onSaveRingtone(Uri ringtoneUri) 
    {
		...
		edit.putString(com.sipgate.sipua.ui.Settings.PREF_SIPRINGTONE, ringtoneUri != null ? ringtoneUri.toString() : com.sipgate.sipua.ui.Settings.DEFAULT_SIPRINGTONE);		
		edit.commit();        
    }
    ...
    {
        String uriString = PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sipgate.sipua.ui.Settings.PREF_SIPRINGTONE,
