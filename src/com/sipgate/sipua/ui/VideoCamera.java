...
public class VideoCamera extends CallScreen implements 
    ...
    private boolean initializeVideo() {
		...
		videoQualityHigh = PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sipgate.sipua.ui.Settings.PREF_VQUALITY, com.sipgate.sipua.ui.Settings.DEFAULT_VQUALITY).equals("high");
