...
import com.sipgate.sipua.phone.Connection;
	...
	public class Receiver extends BroadcastReceiver {
			...
			if (call_state != state) {
				...
				case UserAgent.UA_STATE_INCOMING_CALL:
					...
					if ((pstn_state == null || pstn_state.equals("IDLE")) &&
							PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_AUTO_ON, com.sipgate.sipua.ui.Settings.DEFAULT_AUTO_ON) &&
						...
						if (am.getStreamVolume(AudioManager.STREAM_RING) > 0) {				 
							String sUriSipRingtone = PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sipgate.sipua.ui.Settings.PREF_SIPRINGTONE,
		...
		public static void onText(int type,String text,int mInCallResId,long base) {
	        ...
	        if (text != null) {
				...
				if (type == MISSED_CALL_NOTIFICATION) {
			        	...
			        	if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_NOTIFY, com.sipgate.sipua.ui.Settings.DEFAULT_NOTIFY)) {
		        	...
		        	default:
						notification.contentIntent = PendingIntent.getActivity(mContext, 0,
					            createIntent(com.sipgate.ui.SipgateFrames.class), 0);
					...
					} else if (type == REGISTER_NOTIFICATION && PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_POS, com.sipgate.sipua.ui.Settings.DEFAULT_POS))
		...
		static void updateAutoAnswer() {
			if (PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_AUTO_ONDEMAND, com.sipgate.sipua.ui.Settings.DEFAULT_AUTO_ONDEMAND) &&
				Sipdroid.on(mContext)) {
				if (PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_AUTO_DEMAND, com.sipgate.sipua.ui.Settings.DEFAULT_AUTO_DEMAND))
					updateAutoAnswer(1);
				else
					updateAutoAnswer(0);
			} else
		...
		public static void pos(boolean enable) {
			...
			if (enable) {
				if (call_state == UserAgent.UA_STATE_IDLE && Sipdroid.on(mContext) &&
						PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_POS, com.sipgate.sipua.ui.Settings.DEFAULT_POS) &&
						PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sipgate.sipua.ui.Settings.PREF_POSURL, com.sipgate.sipua.ui.Settings.DEFAULT_POSURL).length() > 0) {
		...
		static void enable_wifi(boolean enable) {
			if (!PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_OWNWIFI, com.sipgate.sipua.ui.Settings.DEFAULT_OWNWIFI)
					|| !(PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_3G, com.sipgate.sipua.ui.Settings.DEFAULT_3G) ||
							PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_EDGE, com.sipgate.sipua.ui.Settings.DEFAULT_EDGE)))
				return;
			if (enable && !PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_WIFI_DISABLED, com.sipgate.sipua.ui.Settings.DEFAULT_WIFI_DISABLED))
        		return;
    		...
    		edit.putBoolean(com.sipgate.sipua.ui.Settings.PREF_WIFI_DISABLED,!enable);
    		edit.commit();
    		if (enable) {
		...
		public static void url(final String opt) {
	        (new Thread() {
				public void run() {
					try {
				        URL url = new URL(PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sipgate.sipua.ui.Settings.PREF_POSURL, com.sipgate.sipua.ui.Settings.DEFAULT_POSURL)+
				        		"?"+opt);
				        BufferedReader in;
		...
		static boolean on_vpn() {
			return PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_ON_VPN, com.sipgate.sipua.ui.Settings.DEFAULT_ON_VPN);
		}
		
		static void on_vpn(boolean enable) {
    		Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
    		
    		edit.putBoolean(com.sipgate.sipua.ui.Settings.PREF_ON_VPN,enable);
    		edit.commit();
		}
		...
		static boolean isFastWifi() {
        	...
        	if (wi != null) {
	        	...
	        	if (wi.getIpAddress() != 0 && (WifiInfo.getDetailedStateOf(wi.getSupplicantState()) == DetailedState.OBTAINING_IPADDR
	        		...
	        		on_wlan = true;
	        		if (!on_vpn())
	        			return PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_WLAN, com.sipgate.sipua.ui.Settings.DEFAULT_WLAN);
	        		else
	        			return PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_VPN, com.sipgate.sipua.ui.Settings.DEFAULT_VPN);  
	        	}
        	}
        	on_wlan = false;
        	return false;
		...
		static boolean isFastGSM() {
        	...
        	if (tm.getNetworkType() >= TelephonyManager.NETWORK_TYPE_UMTS)
        		return PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_3G, com.sipgate.sipua.ui.Settings.DEFAULT_3G);
        	if (tm.getNetworkType() == TelephonyManager.NETWORK_TYPE_EDGE)
       			return PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sipgate.sipua.ui.Settings.PREF_EDGE, com.sipgate.sipua.ui.Settings.DEFAULT_EDGE);
        	return false;
		}
